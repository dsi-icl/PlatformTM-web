...
function SubjectConfigService($resource, ngAppConfig) {
    ...
    var _datasetResource = $resource(serviceBase+'templates/subject/:datasetId',{},{
        update:{
            method: 'PUT',
            params: {datasetId: '@id'}
        },
...
angular.module('bioSpeak.config')
    .factory('SubjectConfigService',['$resource','ngAppConfig', SubjectConfigService])
