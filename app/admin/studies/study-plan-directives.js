            ...
            template:
                '<div  class="epoch" ng-class-odd="\'odd\'" >' +
                    '<div  class="epoch-header">' +
                        '<a  e-ng-model="epoch" editable-text="epoch.name"  e-form="editTextForm" buttons="no" blur="submit">{{epoch.name || "Enter Epoch name"}}</a>' +/**/
        ...
        return{
            ...
            template:
                '<div style="display: inline-block">' +
                    ...
                    '<a e-ng-model="cellname" editable-text="cell.name"  e-form="editTextForm" buttons="no" blur="submit">{{cell.name || "Enter Visit name"}}</a>' +/**/
                    '<span class="glyphicon glyphicon-pencil" ng-click="editTextForm.$show()"  ng-show="isVisible" style="color: #39b3d7; padding-left: 6px; font-size: 0.7em"></span>'+
                    '</div>'+
