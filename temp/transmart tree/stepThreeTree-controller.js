 ...
 */
'use strict';
function stepThreeTreeController($scope, $state, $stateParams,$timeout,exportService){
...
angular.module('bioSpeak.export')
    .controller('stepThreeTreeController',['$scope','$state','$stateParams','$timeout','exportService', stepThreeTreeController]);